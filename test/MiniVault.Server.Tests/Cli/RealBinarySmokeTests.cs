...
public class RealBinarySmokeTests : IAsyncLifetime
{
    ...
    {
        // test bin: <repo>/test/MiniVault.Server.Tests/bin/<Config>/net10.0 -> server bin: <repo>/src/MiniVault.Server/bin/<Config>/net10.0/minivault.dll
        ...
        var dll = Path.Combine(repoRoot, "src", "MiniVault.Server", "bin", config, "net10.0", "minivault.dll");
